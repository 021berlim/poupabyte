...
>(({ className, ...props }, ref) => (
 <ToastPrimitives.Viewport
  ref={ref}
  className={cn(
   'fixed top-0 z-[100] flex max-h-dvh w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col sm:pb-[calc(1rem+env(safe-area-inset-bottom,0px))] md:max-w-[420px]',
   className,
  )}
  {...props}
 />
